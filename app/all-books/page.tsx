...
export default function AllBooksPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300 py-24">
      <div className="max-w-6xl mx-auto space-y-12 px-4 sm:px-6 lg:px-8 w-full">
        {/* Search Filter Bar */}
        <motion.div
